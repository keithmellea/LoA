...
const MyComponent = () => {
  ...
  const pixiLoader = () => { loader.add("images/treasureHunter.json").load(setup); 
  };
  ...
  function setup() {
    ...
    console.log(resources["images/treasureHunter.json"]);
    id = resources["images/treasureHunter.json"].textures["dungeon.png"];
    console.log(id);
    //Dungeon
    dungeon = new Sprite(id);
